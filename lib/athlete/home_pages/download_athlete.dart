...
class DownloadAthlete extends StatefulWidget {
  const DownloadAthlete({Key? key}) : super(key: key);

  @override
  State<DownloadAthlete> createState() => _DownloadAthleteState();
}

class _DownloadAthleteState extends State<DownloadAthlete> {
